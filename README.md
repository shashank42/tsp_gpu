...
This project is still very much in beta, but running the algorithm on the classic [mona lisa](http://www.math.uwaterloo.ca/tsp/data/ml/monalisa.html) problem for 45 minutes yielded a trip length of 2,553,391,104 and made a very nice picture which you can also generate with the given jupyter notebook.
