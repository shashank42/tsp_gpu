...
****************************************************/
 ...
 int main(){
     ...
     read_tsp(tsp_name);
     // instead of rewriting everything I'm setting N to the size of dim.
     int N = meta -> dim;
     ...
     float T = 9999999,T_start = 9999999, *T_g, *r_g;
     ...
     */
     ...
     //The starting loss was 33,346,203,648 and the final loss was 10,243,860,480 
     while (T > 1){
         // Init parameters
         global_flag_h = 0;
