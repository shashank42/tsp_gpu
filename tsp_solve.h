...
__global__ static void tsp(unsigned int* city_one,
    ...
    //note that these parameters' value can't be adjusted, they're optimum, by some mysterious math theory
    ...
    int city_two_swap = ((int)(city_one_swap + (int)floor(((float)r_r / 2147483647 * 2 - 1)*
